 ...
 * {@link Color} value type that is discussed in Chapter 3. Until then,
 ...
 * <li> {@link #setScale(double min, double maxGetter)}
 * </ul>
 * <p>
 ...
 * </ul>
 * <p>
 * You use the {@link Font} value type to specify the font. This allows you to
 ...
 * Standard drawing is capable of drawing large amounts of value.
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * @throws IllegalArgumentException if {@code (maxGetter == min)}
     */
